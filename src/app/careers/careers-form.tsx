			...
			<form onSubmit={handleSubmit} className="space-y-6">
				...
				<div>
					...
					<div className="relative">
						...
						<input
							...
							className="w-full pl-10 pr-3 py-2 bg-background border border-accent/30 rounded-lg focus:outline-none focus:ring-2 focus:ring-accent focus:border-transparent text-foreground placeholder-muted-foreground min-h-[48px]"
					...
					<div>
						...
						<div className="relative">
							...
							<input
								...
								id="xProfile"
								name="xProfile"
								aria-label="Your X (Twitter) profile URL"
				...
				<div>
					...
					<div className="relative">
						...
						<label
							htmlFor="cv"
							className="flex items-center justify-center w-full px-4 py-3 bg-background border-2 border-dashed border-accent/30 rounded-lg cursor-pointer hover:border-accent transition-colors min-h-[48px]"
						>
				...
				<div>
					...
					<textarea
						...
						required
						rows={6}
						aria-label="Tell us about yourself and your experience"
						aria-required="true"
				...
				<div className="pt-4">
					<Button
						type="submit"
						className="w-full bg-accent dark:bg-accent/60 text-white dark:text-white dark:border border-foreground dark:border-accent shadow-md hover:shadow-lg transition-all duration-200 hover:bg-accent/60 hover:dark:bg-accent/30 text-base px-6 py-3 min-h-[48px]"
